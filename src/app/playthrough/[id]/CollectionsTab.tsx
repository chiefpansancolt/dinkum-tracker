...
export default function CollectionsTab({ collections, onUpdate }: CollectionsTabProps) {
	...
	const handleToggleItem = (collectionType: keyof typeof collections, itemId: string) => {
		...
		<div className="space-y-6">
			<Accordion>
				<AccordionPanel>
					...
					<AccordionContent>{renderCollectionItems(animals, "animals")}</AccordionContent>
				</AccordionPanel>
				...
				<AccordionPanel>
					...
					<AccordionContent>{renderCollectionItems(fish, "fish")}</AccordionContent>
				</AccordionPanel>
				...
				<AccordionPanel>
					...
					<AccordionContent>{renderCollectionItems(bugs, "bugs")}</AccordionContent>
				</AccordionPanel>
