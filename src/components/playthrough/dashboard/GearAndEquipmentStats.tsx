			...
			<div className="flex h-full flex-col">
				...
				<div className="flex-grow overflow-auto">
					<div className="space-y-5">
						...
						<div className="mt-4 grid grid-cols-2 gap-4">
							...
							<div className="rounded-lg bg-orange-50 p-3 dark:bg-orange-900/20">
								...
								<div className="mt-1 flex items-center justify-between">
									...
									<Badge color={progressColorMap[leastCompleteCategory] as string}>
										{
						...
						{totalStats.collected > 0 && (
							<div className="rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
								<h3 className="mb-2 text-base font-medium">
									Collection Highlights
								</h3>
								{stats.weapons.collected > 0 && (
									<p className="text-sm">
										<span className="font-medium">Weapons:</span>{" "}
										{stats.weapons.collected} collected
									</p>
								)}
								{stats.tools.collected > 0 && (
									<p className="text-sm">
										<span className="font-medium">Tools:</span>{" "}
										{stats.tools.collected} collected
									</p>
								)}
								{stats.vehicles.collected > 0 && (
									<p className="text-sm">
										<span className="font-medium">Vehicles:</span>{" "}
										{stats.vehicles.collected} collected
									</p>
								)}
							</div>
						)}
