			...
			<div className="space-y-8">
				<Card className="bg-secondary/20 p-6 shadow-md">
					...
					<p className="mb-6 text-lg">
						Track your progress as you play through the relaxing world of Dinkum. Keep
						track of animals you've seen, fish you've caught, bugs you've collected, and
				...
				<Card className="bg-accent/10">
					...
					<ol className="list-inside list-decimal space-y-3">
						<li>
							<span className="font-medium">Create a new playthrough</span> - Give
							your game a name to help you keep track
						</li>
						<li>
							<span className="font-medium">Update your progress</span> - Check off
							items as you collect them in-game
						</li>
						<li>
							<span className="font-medium">Save automatically</span> - Your progress
							is saved locally to your device
						</li>
						<li>
