...
import { CraftingRecipesTabHandle, CraftingRecipesTabProps } from "@/types/dinkum";

const CraftingRecipesTab = forwardRef<CraftingRecipesTabHandle, CraftingRecipesTabProps>(
	({ unlocked }, ref) => {
			...
			<div className="space-y-6">
				<div>
					<div className="mb-2 flex items-center justify-between">
						...
						<Badge color="blue" size="lg">
							{Math.round((getunlockedCount() / craftingRecipes.length) * 100)}%
							unlocked
						</Badge>
					</div>
				...
				<div className="mb-4">
					<p className="text-primary font-medium">
						Showing {filteredRecipes.length} of {craftingRecipes.length} recipes •
