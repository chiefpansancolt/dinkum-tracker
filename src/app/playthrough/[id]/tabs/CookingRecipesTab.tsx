		...
		<div className="space-y-6">
			<div>
				<div className="mb-2 flex items-center justify-between">
					...
					<Badge color="blue" size="lg">
						{Math.round((getUnlockedCount() / cookingRecipes.length) * 100)}% unlocked
					</Badge>
				</div>
			...
			<div className="mb-4">
				<p className="text-primary font-medium">
					Showing {filteredRecipes.length} of {cookingRecipes.length} recipes • Unlocked:{" "}
					{getUnlockedCount()}
							...
							>
								<div className="flex h-full flex-col">
									...
									<div className="mt-2 flex-grow space-y-3 text-sm">
										<div className="flex">
											<p className="w-32 font-medium">Cooking Location:</p>
